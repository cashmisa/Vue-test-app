    ...
    <div class="signup-form">
      <form @submit.prevent="onSubmit">
        <div class="input" :class="{ invalid: $v.email.$error}">
          ...
          <small v-if="!$v.email.unique" class="text-danger">Email is taken</small>
        </div>
        </div>
        <div class="input" :class="{ invalid: $v.age.$error}">
         ...
         <div v-if="$v.age.$error">
          <small v-if="!$v.age.minValue || !$v.age.numeric" class="text-danger">Must be at least {{ $v.age.$params.minValue.min}}</small>
          <small v-if="!$v.age.required" class="text-danger">Age is required</small>
          </div>
        </div>
